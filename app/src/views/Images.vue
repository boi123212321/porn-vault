    ...
    <v-navigation-drawer v-if="showSidenav" style="z-index: 14" v-model="drawer" clipped app>
      <v-container>
        ...
        <div class="d-flex align-center">
          ...
          <v-btn
            :color="excludeAutoGenerated ? 'primary' : undefined"
            icon
            @click="excludeAutoGenerated = !excludeAutoGenerated"
          >
            <v-icon>{{ excludeAutoGenerated ? 'mdi-filmstrip-off' : 'mdi-filmstrip' }}</v-icon>
          </v-btn>
        ...
        <v-select
          ...
          :items="sortDirItems"
        ></v-select>
        <Divider icon="mdi-settings">Options</Divider>

        <v-checkbox
          color="primary"
          hide-details
          v-model="showAutoGeneratedImages"
          label="Show auto-generated images"></v-checkbox>

        <v-checkbox 
          hide-details 
          color="primary" 
          v-model="largeThumbs" 
          label="Large thumbnails"></v-checkbox>
...
export default class ImageList extends mixins(DrawerMixin) {
  ...
  includeAutoGenerated = localStorage.getItem("pm_includeAutoGenerated") == "true" || false;
  ...
  excludeAutoGenerated = localStorage.getItem("pm_excludeAutoGenerated") == "true";
  ...
  @Watch("excludeAutoGenerated")
  onExcludeAutoGeneratedChange(newVal: boolean) {
    localStorage.setItem("pm_excludeAutoGenerated", "" + newVal);
    imageModule.resetPagination();
    this.loadPage(this.page);
  }
  ...
  async fetchPage(page: number, take = this.imagesPerPage, random?: boolean, seed?: string) {
    try {
      ...
      const query = `query:'${this.query ||
        ...
        this.ratingFilter
      } excludeAutoGenerated:${this.excludeAutoGenerated ? "true" : "false"}
      `;
